    ...
    <footer className="bg-secondary text-secondary-foreground">
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-sm">
              Capturing authentic moments and creating timeless memories through
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center">
                ...
                <Link
                  href="mailto:hello@luminaphotography.com"
                  className="text-muted-foreground hover:text-accent transition-colors"
                >
        ...
        <div className="border-t border-border mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0 text-sm text-muted-foreground sm:flex flex-wrap justify-center text-center">
            <Link
              href="/privacypolicy"
            ...
            <Link href="/T&C" className="whitespace-nowrap hover:text-accent transition-colors">
              Terms of Service
            </Link>
            <span className="mx-2">·</span>
            <Link
